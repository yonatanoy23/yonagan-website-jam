...
// audio assets
const good_sound = new Audio(encodeURI('/Audio assets/ding.mp3'));
const bad_sound = new Audio(encodeURI('/Audio assets/swoosh.mp3'));
const Roulette_sound = new Audio(encodeURI('/Audio assets/roleta.mp3'));
const Roulette_victory_sound = new Audio(encodeURI('/Audio assets/roleta_victory.mp3'))
...
function setupHighLow() {
  ...
  if (cardImg) {
    cardImg.src = `/Image assets/card images/card-${cardNumber}-${shape}.svg`;
  }
  ...
  function guessHigh() {
    ...
    if (cardImg) cardImg.src = `/Image assets/card images/card-${cardNumber}-${shape}.svg`;
